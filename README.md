Vi điều khiển: ESP32  
Cảm biến: cảm biến DHT11, Độ ẩm đất giao tiếp I2c, Cường độ ánh sáng BH1750
Màn Hình Oled 1.3
...
Member 1: Arduino & Firmware (Khôi)  
...
Member 2: API (GET,POST, Control, Api xác thực) & Database (Hoàng Và Phúc )   
